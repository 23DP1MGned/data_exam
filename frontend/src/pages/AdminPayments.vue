...
const overviewStats = computed(() => [
  {
    label: t('pages.adminPayments.statTotalPaid'),
    value: formatCurrency(paymentsData.value.summary?.total_paid ?? 0),
    caption: t('pages.adminPayments.statCaptionCollected'),
    icon: 'mdi-cash-check',
    tone: 'attendance'
  },
  {
    label: t('pages.adminPayments.statPending'),
    value: formatCurrency(paymentsData.value.summary?.pending ?? 0),
    caption: t('pages.adminPayments.statCaptionAwaitingPayment'),
    icon: 'mdi-timer-sand',
    tone: 'payments'
  },
  {
    label: t('pages.adminPayments.statOverdue'),
    value: formatCurrency(paymentsData.value.summary?.overdue ?? 0),
    caption: t('pages.adminPayments.statCaptionPastDue'),
    icon: 'mdi-alert-circle-outline',
    tone: 'alert'
  },
  {
    label: t('pages.adminPayments.statPaymentRecords'),
    value: paymentRecords.value.length,
    caption: t('pages.adminPayments.statCaptionSavedRecords'),
