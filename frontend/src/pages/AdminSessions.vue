...
const overviewStats = computed(() => [
  {
    label: t('pages.adminSessions.statWeeklyTrainings'),
    value: filteredWeeklyTrainings.value.length,
    caption: t('pages.adminSessions.statCaptionRecurringTemplates'),
    icon: 'mdi-calendar-sync-outline',
    tone: 'time'
  },
  {
    label: t('pages.adminSessions.statSessionDates'),
    value: sessions.value.length,
    caption: t('pages.adminSessions.statCaptionGeneratedSessions'),
    icon: 'mdi-calendar-month-outline',
    tone: 'groups'
  },
  {
    label: t('pages.adminSessions.statPlanned'),
    value: sessions.value.filter((item) => item.status === 'planned').length,
    caption: t('pages.adminSessions.statCaptionUpcomingSchedule'),
    icon: 'mdi-clock-outline',
    tone: 'users'
  },
  {
    label: t('pages.adminSessions.statCompleted'),
    value: sessions.value.filter((item) => item.status === 'completed').length,
    caption: t('pages.adminSessions.statCaptionAlreadyCompleted'),
    icon: 'mdi-check-decagram-outline',
    tone: 'attendance'
  },
  {
    label: t('pages.adminSessions.statCancelled'),
    value: sessions.value.filter((item) => item.status === 'cancelled').length,
    caption: t('pages.adminSessions.statCaptionCancelledItems'),
