...
const overviewStats = computed(() => {
  ...
  return [
    {
      label: t('pages.coachAttendance.statAverageAttendanceRate'),
      value: `${averageAttendanceRate}%`,
      caption: t('pages.coachAttendance.statCaptionPresentRate'),
      icon: 'mdi-chart-donut',
      tone: 'attendance'
    },
    {
      label: t('pages.coachAttendance.statCancelledThisMonth'),
      value: String(cancelledThisMonth),
      caption: t('pages.coachAttendance.statCaptionCancelled'),
      icon: 'mdi-close-octagon-outline',
      tone: 'alert'
    },
    {
      label: t('pages.coachAttendance.statSessionsThisMonth'),
      value: String(sessionsThisMonth),
      caption: t('pages.coachAttendance.statCaptionThisMonthSessions'),
      icon: 'mdi-calendar-month-outline',
      tone: 'time'
    },
    {
      label: t('pages.coachAttendance.statMarkedThisMonth'),
      value: String(markedRecordsThisMonth),
      caption: t('pages.coachAttendance.statCaptionSavedRecords'),
