              ...
              <div class="attendance-overview">
                ...
                <div class="overview-main">
                  ...
                  <StatsOverviewGrid
                    ...
                    :items="stats"
                    :dark-mode="darkMode"
                    :hide-captions="isParent || ['child', 'adult'].includes(user?.role ?? '')"
                    variant="admin"
                  />
...
const scopedCalendarSessions = computed(() =>
  calendarSessions.value.filter((session) => {
    if (['child', 'adult'].includes(user.value?.role ?? '')) {
...
const stats = computed(() => [
  {
    label: t('pages.attendance.statTotalTrainingTime'),
    value: formatMinutes(summary.value.total_training_time_minutes ?? 0),
    caption: t('pages.attendance.statCaptionLoggedMinutes'),
    icon: 'mdi-timetable',
    tone: 'time'
  },
  {
    label: t('pages.attendance.statTotalSessions'),
    value: String(summary.value.total_sessions ?? 0),
    caption: t('pages.attendance.statCaptionSessionsInRange'),
    icon: 'mdi-calendar-range-outline',
    tone: 'groups'
  },
  {
    label: t('pages.attendance.statAttendedSessions'),
    value: String(summary.value.attended_sessions ?? 0),
    caption: t('pages.attendance.statCaptionPresentMarks'),
    icon: 'mdi-check-decagram-outline',
    tone: 'attendance'
  },
  {
    label: t('pages.attendance.statMissedSessions'),
    value: String(summary.value.missed_sessions ?? 0),
    caption: t('pages.attendance.statCaptionAbsentMarks'),
