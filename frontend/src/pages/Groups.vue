  ...
  <v-app>
    <v-main class="groups-page">
      ...
      <div
        class="groups-shell"
        :class="{
          'groups-shell-dark': darkMode,
          'groups-shell-coach': isCoach,
          ...
          <section class="content-shell">
            ...
            <div class="groups-card">
              <div class="groups-header">
                ...
                <StatsOverviewGrid
                  v-if="isCoach"
                  class="coach-header-stats"
                  :items="coachOverviewStats"
                  :dark-mode="darkMode"
                  hide-captions
                  variant="compact"
                />
...
const coachOverviewStats = computed(() => {
  ...
  return [
    {
      label: t('pages.groups.statMyGroups'),
      value: String(groupCount),
      caption: t('pages.groups.statCaptionGroupsYouLead'),
      icon: 'mdi-google-circles-communities',
      tone: 'groups'
    },
    {
      label: t('pages.groups.statStudentsTotal'),
      value: String(totalStudents),
      caption: t('pages.groups.statCaptionStudentsInYourGroups'),
...
.groups-shell-coach .brand-icon,
.groups-shell-coach .nav-item-active,
.groups-shell-coach .attendance-fill {
